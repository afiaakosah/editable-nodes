...
export const CreateNodeModal = (props: ICreateNodeModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    if (selectedType === 'temporal' && !ReactPlayer.canPlay(content)){
      setError('React player is unable to play this media.')
      return
    }
    const attributes = {
      content,
  ...
  const isTemporal: boolean = selectedType === 'temporal'
