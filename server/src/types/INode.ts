...
export interface INode {
  ...
  originalHeight?: number // image's orginal height
  originalWidth?: number // image's orginal width
  newHeight?: number // image's height after it has been editted
  newWidth?: number // image's width after it has been editted
  canvasXYPos?: {x: number, y: number} | undefined // x-y co-ordinates for the freeform canvas view
}
